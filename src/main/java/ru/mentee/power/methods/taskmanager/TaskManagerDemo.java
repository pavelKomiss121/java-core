...
public class TaskManagerDemo {
    ...
    public static void main(String[] args) {
        ...
        taskManager.addTask("Подготовить отчёт", "Финансовый отчёт за Q2", createDate(2023, 7, 1), Task.Priority.HIGH);
        taskManager.addTask("Позвонить клиенту", "Обсудить условия сделки", createDate(2023, 6, 25), Task.Priority.MEDIUM);
        taskManager.addTask("Уборка стола", "Почистить рабочее место", createDate(2023, 8, 10), Task.Priority.LOW);
