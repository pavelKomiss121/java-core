...
public class TaskManager {
  ...
  /**
   * Сортировка задач по сроку выполнения Использует алгоритм сортировки пузырьком из блока циклов
   */
  ...
  /**
   * Сортировка задач по приоритету Использует алгоритм сортировки вставками из блока циклов
   */
