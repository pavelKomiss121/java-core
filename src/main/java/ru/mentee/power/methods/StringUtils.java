...
public class StringUtils {
  ...
  /**
   * Обрезает строку до указанной максимальной длины. Если строка длиннее maxLength, добавляет "..."
   * в конце.
   *
   * @param str       Исходная строка
  ...
  /**
   * Заменяет все последовательности пробельных символов одним пробелом. Удаляет пробелы в начале и
   * конце строки.
   *
   * @param str Исходная строка
