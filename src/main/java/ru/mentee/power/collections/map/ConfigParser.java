...
public class ConfigParser {
    ...
    public void parseConfig(String configString) {
        if (configString == null) throw new IllegalArgumentException();
    ...
    public int getIntValue(String key) {
        if (!configMap.containsKey(key)) throw new NoSuchElementException();
    ...
    public List<String> getListValue(String key) {
        ...
        for (String part : parts){
            ...
            if (!partTrim.isEmpty()) result.add(partTrim);
        }
        return result;
    }
