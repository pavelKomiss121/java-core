...
public class SimpleCollectionTasks {
  ...
  /**
   * Подсчитывает количество строк в списке, начинающихся с заданной буквы (без учета регистра).
   *
   * @param strings   Список строк.
   * @param startChar Начальная буква.
   * @return Количество строк, начинающихся с startChar. Возвращает 0, если список равен null или
   * пуст.
   */
