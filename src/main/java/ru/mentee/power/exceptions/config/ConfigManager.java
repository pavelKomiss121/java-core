...
public class ConfigManager {
    ...
    public int getRequiredIntValue(String key)
        ...
        try {
            ...
            throw new InvalidConfigValueException("Значение по ключу '" + key + "' не является числом: " + value);
        }
    }
    ...
    public boolean getRequiredBooleanValue(String key)
        ...
        throw new InvalidConfigValueException("Значение по ключу '" + key + "' не является булевым: " + value);
    }
