...
public class UnitConverter {
    ...
    private double convertLength(double value, String fromUnit, String toUnit) {
        ...
        double meters;
        switch (fromUnit) {
            case "Метр": meters = value; break;
            case "Сантиметр": meters = value / 100; break;
            case "Дюйм": meters = value / 39.37; break;
            case "Фут": meters = value / 3.28; break;
            default: return ERROR_CODE;
        }
        switch (toUnit) {
            case "Метр": return meters;
            case "Сантиметр": return meters * 100;
            case "Дюйм": return meters * 39.37;
            case "Фут": return meters * 3.28;
            default: return ERROR_CODE;
        }
    }
    ...
    private double convertWeight(double value, String fromUnit, String toUnit) {
        ...
        double kilograms;
        switch (fromUnit) {
            case "Килограмм": kilograms = value; break;
            case "Грамм": kilograms = value / 1000; break;
            case "Фунт": kilograms = value / 2.20462; break;
            case "Унция": kilograms = value / 35.274; break;
            default: return ERROR_CODE;
        }
        switch (toUnit) {
            case "Килограмм": return kilograms;
            case "Грамм": return kilograms * 1000;
            case "Фунт": return kilograms * 2.20462;
            case "Унция": return kilograms * 35.274;
            default: return ERROR_CODE;
        }
    }
    ...
    private double convertTemperature(double value, String fromUnit, String toUnit) {
        ...
        double celsius;
        switch (fromUnit) {
            case "Цельсий": celsius = value; break;
            case "Фаренгейт": celsius = (value - 32) * 5 / 9; break;
            case "Кельвин": celsius = value - 273.15; break;
            default: return ERROR_CODE;
        }
        switch (toUnit) {
            case "Цельсий": return celsius;
            case "Фаренгейт": return (celsius * 9 / 5) + 32;
            case "Кельвин": return celsius + 273.15;
            default: return ERROR_CODE;
        }
    }
