...
public class CarEcoRating {
  ...
  public int calculateEcoRating(String fuelType, double engineVolume,
    ...
    int finalRating = applyRatingModifiers(baseRating, fuelType, engineVolume, fuelConsumption,
  ...
  private int applyRatingModifiers(int baseRating, String fuelType, double engineVolume,
    ...
    int agePenalty = Math.max(0,
        yearOfManufacture < EURO_STANDARD_YEAR_THRESHOLD ? EURO_STANDARD_YEAR_THRESHOLD
            - yearOfManufacture : 0);
    rating -= agePenalty;
