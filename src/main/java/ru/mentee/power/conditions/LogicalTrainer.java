...
public class LogicalTrainer {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\nРезультаты проверок:");
    System.out.println(
        "Утверждение 1: Вы любите и программирование, и математику: " + results.get(1));
    System.out.println(
        "Утверждение 2: Вы любите программирование или чтение книг: " + results.get(2));
    System.out.println(
        "Утверждение 3: Вы любите математику, но не любите читать книги: " + results.get(3));
    System.out.println(
        "Утверждение 4: Вы не любите ни программирование, ни математику: " + results.get(4));
