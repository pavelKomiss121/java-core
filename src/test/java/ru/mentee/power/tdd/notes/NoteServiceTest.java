...
class NoteServiceTest {
    ...
    class AddNoteTests {
        ...
        void shouldAddValidNote() {
            ...
            for (String tag : tags) {tagsLowerCase.add(tag.toLowerCase());}
    ...
    class UpdateNoteTests {
        ...
        void shouldUpdateNoteTitle() {
            ...
            assertThatThrownBy(() -> n.setTitle(null))
                    .isInstanceOf(IllegalArgumentException.class);
        }
        ...
        void shouldAddNewTagLowercased() {
            ...
            Optional<Note> foundOpt = noteService.getNoteById(n.getId());
            assertThat(foundOpt).isPresent();
            assertThat(foundOpt.orElseThrow().getTags())
    ...
    class TagTests {
        ...
        void shouldReturnUniqueLowercasedTags() {
            ...
            assertThat(tags)
                    .containsExactlyInAnyOrder("java", "tdd", "gradle", "build");
        }
