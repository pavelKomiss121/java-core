...
class SmartThermostatTest {
  ...
  void getTargetTemperatureForWeekdayMorningOccupied() {
    ...
    // Act
    double targetTemp = thermostat.getTargetTemperature(timeOfDay, dayOfWeek, isOccupied,
        outsideTemp);
  ...
  @CsvSource({ // timeOfDay, dayOfWeek, isOccupied, outsideTemp, expectedTemp
      ...
      "3, Воскресенье, true, -1.0, 19.0"
      // Выходной, ночь, занято, холодно (-1) - ожидается 19.0
  })
